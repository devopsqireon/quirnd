...
import CreatePasswordForm from '@/component/forms/CreatePasswordForm';
                ...
                <div className="p-8 ps-0 flex-col justify-center hidden lg:flex">
                    <div>
                        ...
                        <ul className="space-y-4">
                            <FeatureListItem>Protect your account from unauthorized access</FeatureListItem>
                            <FeatureListItem>Ensure the confidentiality of your compliance data</FeatureListItem>
                            <FeatureListItem>Enable features like secure single sign-on</FeatureListItem>
                        </ul>

                        <div className="mt-12 p-4 bg-white/50 border-l-4 border-cyan-400 rounded-r-lg">
                            <p className="text-sm italic">
                                A unique, complex password is your first line of defense in maintaining a secure and compliant digital environment.
                            </p>
                        </div>
                    </div>
                </div>
